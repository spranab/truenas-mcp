...
export function register(server: McpServer, client: TrueNASClient): void {
  ...
  server.tool(
    ...
    "List all SMB shares",
    {},
    async () => jsonContent(await client.get("/sharing/smb")),
  );
  ...
  server.tool(
    ...
    async ({ id }) => jsonContent(await client.get(`/sharing/smb/id/${id}`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/smb")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/sharing/nfs")),
  );
  ...
  server.tool(
    ...
    async ({ id }) => jsonContent(await client.get(`/sharing/nfs/id/${id}`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/nfs")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/nfs/client_count")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/iscsi/global")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/iscsi/target")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/iscsi/extent")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/iscsi/portal")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/iscsi/initiator")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/iscsi/targetextent")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/iscsi/global/sessions")),
  );
}
