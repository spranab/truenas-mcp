...
export function register(server: McpServer, client: TrueNASClient): void {
  ...
  server.tool(
    ...
    async ({ id, ...props }) => {
      ...
      const result = await client.post(
        `/pool/dataset/id/${encodeURIComponent(id)}/permission`,
        body,
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  ...
  server.tool(
    ...
    async ({ id, quota_type }) => {
      const result = await client.post(
        `/pool/dataset/id/${encodeURIComponent(id)}/get_quota`,
        { quota_type },
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  ...
  server.tool(
    ...
    async ({ id, quotas }) => {
      const result = await client.post(
        `/pool/dataset/id/${encodeURIComponent(id)}/set_quota`,
        quotas,
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  ...
  server.tool(
    ...
    async ({ id }) => {
      const result = await client.post(
        `/pool/dataset/id/${encodeURIComponent(id)}/promote`,
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  );
  ...
  server.tool(
    ...
    async ({ id }) => {
      const result = await client.post(
        `/pool/dataset/id/${encodeURIComponent(id)}/encryption_summary`,
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  );
  ...
  server.tool(
    ...
    async ({ id }) => {
      const result = await client.post(
        `/pool/dataset/id/${encodeURIComponent(id)}/lock`,
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  );
  ...
  server.tool(
    ...
    async ({ id, unlock_options }) => {
      const result = await client.post(
        `/pool/dataset/id/${encodeURIComponent(id)}/unlock`,
        unlock_options ?? {},
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  ...
  server.tool(
    ...
    async ({ id, defer, confirm }) => {
      ...
      const result = await client.delete(
        `/pool/snapshot/id/${encodeURIComponent(id)}`,
        body,
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  ...
  server.tool(
    ...
    async ({ id, dataset_dst }) => {
      const result = await client.post(
        `/pool/snapshot/id/${encodeURIComponent(id)}/clone`,
        { dataset_dst },
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
  ...
  server.tool(
    ...
    async ({ id, recursive, recursive_clones, force, confirm }) => {
      ...
      const body: Record<string, unknown> = {};
      if (recursive !== undefined) body.recursive = recursive;
      if (recursive_clones !== undefined) body.recursive_clones = recursive_clones;
      if (force !== undefined) body.force = force;
      const result = await client.post(
        `/pool/snapshot/id/${encodeURIComponent(id)}/rollback`,
        body,
      );
      return { content: [{ type: "text", text: JSON.stringify(result, null, 2) }] };
    },
