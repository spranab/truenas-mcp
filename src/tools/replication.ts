...
export function register(server: McpServer, client: TrueNASClient): void {
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/replication")),
  );
  ...
  server.tool(
    ...
    async ({ id }) => jsonContent(await client.get(`/replication/id/${id}`)),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Replication task ID") },
    async ({ id }) => jsonContent(await client.post(`/replication/id/${id}/run`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/cloudsync")),
  );
  ...
  server.tool(
    ...
    async ({ id }) => jsonContent(await client.get(`/cloudsync/id/${id}`)),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Cloud sync task ID") },
    async ({ id }) => jsonContent(await client.post(`/cloudsync/id/${id}/sync`)),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Cloud sync task ID") },
    async ({ id }) => jsonContent(await client.post(`/cloudsync/id/${id}/abort`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/cloudsync/providers")),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/cloudsync/credentials")),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Credential ID") },
    async ({ id }) => jsonContent(await client.delete(`/cloudsync/credentials/id/${id}`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/cloud_backup")),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Cloud backup task ID") },
    async ({ id }) => jsonContent(await client.post(`/cloud_backup/id/${id}/sync`)),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Cloud backup task ID") },
    async ({ id }) => jsonContent(await client.post(`/cloud_backup/id/${id}/abort`)),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Cloud backup task ID") },
    async ({ id }) => jsonContent(await client.post(`/cloud_backup/id/${id}/list_snapshots`)),
  );
  ...
  server.tool(
    ...
    "List all cron jobs",
    {},
    async () => jsonContent(await client.get("/cronjob")),
  );
  ...
  server.tool(
    ...
    "Delete a cron job",
    { id: z.number().describe("Cron job ID") },
    async ({ id }) => jsonContent(await client.delete(`/cronjob/id/${id}`)),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Cron job ID") },
    async ({ id }) => jsonContent(await client.post(`/cronjob/id/${id}/run`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/rsynctask")),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Rsync task ID") },
    async ({ id }) => jsonContent(await client.delete(`/rsynctask/id/${id}`)),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Rsync task ID") },
    async ({ id }) => jsonContent(await client.post(`/rsynctask/id/${id}/run`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/initshutdownscript")),
  );
  ...
  server.tool(
    ...
    { id: z.number().describe("Init/shutdown script ID") },
    async ({ id }) => jsonContent(await client.delete(`/initshutdownscript/id/${id}`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.get("/keychaincredential")),
  );
  ...
  server.tool(
    ...
    async ({ id }) => jsonContent(await client.delete(`/keychaincredential/id/${id}`)),
  );
  ...
  server.tool(
    ...
    {},
    async () => jsonContent(await client.post("/keychaincredential/generate_ssh_key_pair")),
  );
